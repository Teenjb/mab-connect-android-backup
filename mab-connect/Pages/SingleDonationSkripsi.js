...
export default function SingleDonationSkripsi({ route, navigation }) {
  ...
  return (
    <SafeAreaView className=" flex-1 bg-white" >
      ...
      <UniversalHeader lightText="Detail " boldText="Skripsi" />
      ...
      <View className='flex-1 justify-end ' >
        <View>
          <View className=" bg-blue-100 m-6 py-10 rounded-2xl">
            ...
            <Text className=" text-base text-center font-bold" >
              dibimbing oleh {route.params.proposal.namapembimbing}
            </Text>
          </View>
          ...
          <View className="my-3">
            ...
            <Pressable className="m-2 py-5 bg-green-400 active:bg-green-600 rounded-3xl shadow-md  items-center"
              onPress={() => initiatePay(route.params.proposal.skripsiid)}
              >
              <Text
                selectable={false}
                className="text-white text-base font-bold"
